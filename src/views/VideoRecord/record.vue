<template>
  <div class="video-demo-recorder">
    <div class="video-demo-recorder__container">
      <div v-show="!states.isCameraRecordOn && !states.isScreenRecordOn">
        <span>Turn on video or share your screen to record</span>
      </div>
...
async function startRecord() {
  if(!states.isCameraRecordOn && !states.isScreenRecordOn) {

    store.dispatch('houseKeeping/showSnackbar', {
      message: 'Turn on the camera ar share screen.',
      color: 'error',
      timeout: 4000
    })
    return
