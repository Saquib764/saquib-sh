<template>
  <div class="home-page">
    <section id="home">
      Simply record videos. Replace yourself with avatar. No hassle. No ads.
      ...
      <div>
        ...
        <client-only>
          <div class="mt-16">
            <zust-button
              append-icon="mdi-play"
              href="/">Releasing soon</zust-button>
          </div>
        </client-only>
      </div>
    </section>
...
useHead({
  ...
  meta: [{
    name: "description",
    content: "Replace yourself with a 3D model using AI"
  }],
...
useSeoMeta({
  title: "MotionDub",
  ogTitle: "MotionDub",
  description: "Replace yourself with a 3D model using AI",
  ogDescription: "Replace yourself with a 3D model using AI",
