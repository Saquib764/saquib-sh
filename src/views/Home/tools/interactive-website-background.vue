...
const states = reactive({
  ...
  isUploading: false,
  uploadMessage: "",
  image_url: 'https://firebasestorage.googleapis.com/v0/b/saquib-sh.appspot.com/o/depth-2d-to-3d%2F81468.png?alt=media',
  depth_url: 'https://firebasestorage.googleapis.com/v0/b/saquib-sh.appspot.com/o/depth-2d-to-3d%2F81468_depth.png?alt=media',
  x:0,
  y:0,
  z:10,
  scale: 3,
