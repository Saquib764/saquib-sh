<template>
  <div class="home-page">
    <section id="home">
      Get your 3D product photoshoot here. No hassle. No ads.

      <zust-button
              append-icon="mdi-play"
              href="/">Coming soon</zust-button>
    </section>

    <section id="bottom-cta">
      <div>
        <div class="text-sm-h3 text-h4 font-weight-bold mb-6">
          Level up your 3D game with zero effort
        </div>
...
useHead({
  title: "ProductShoot3D",
  meta: [{
    name: "description",
    content: "Get your 3D product photoshoot here. No hassle. No ads."
  }],
...
useSeoMeta({
  title: "ProductShoot3D",
  ogTitle: "ProductShoot3D",
  description: "Get your 3D product photoshoot here. No hassle. No ads.",
  ogDescription: "Get your 3D product photoshoot here. No hassle. No ads.",
